...
public class RegistrarClienteController implements Initializable {
     ...
     */
    @FXML
    void actualizarCliente(ActionEvent event) throws ClienteNoRegistradoException, AtributosVaciosException {
        try {
            ...
            /*mostrarMensaje("Notificacion AlquilaFacil", "Cliente no seleccionado", "No se ha seleccionado " +
     ...
     */
    @FXML
    void crearCliente(ActionEvent event)throws AtributosVaciosException, CLienteYaExistenteException {
        try {
